...
public class ViDuFile {
	...
	public static void main(String[] args) {
		File f0 = new File("C:\\Users\\Admin\\eclipse-workspace\\Bai 70\\file_1.txt");
		File f1 = new File("C:\\Users\\Admin\\eclipse-workspace\\Bai 70\\file_2.txt");
		File f2 = new File("C:\\Users\\Admin\\eclipse-workspace\\Bai 70\\file_2xyz.txt");
	...
	//	} catch (IOException e) {
		...
		// 2. Di chuyen file
		//File f_2new= new File("C:\\Users\\Admin\\eclipse-workspace\\Bai 70\\F0\\file_2.txt");
		//try {
		...
		// 3. Copy file
		File f_0 = new File("C:\\Users\\Admin\\eclipse-workspace\\Bai 70\\F0");
		File f_0_copy = new File("C:\\Users\\Admin\\eclipse-workspace\\Bai 70\\F0_copy");
		try {
